...
figure 
% plot(0.04:0.02:0.2,line4,'Color',c{1},'LineWidth',0.75,'LineStyle','-','Marker','o','MarkerFaceColor',c{1})
% hold on
 plot(0.02:0.01:0.1,line3,'Color',c{2},'LineWidth',0.75,'LineStyle','-.','Marker','*','MarkerFaceColor',c{2})
 hold on
